    ...
    <div class="modal-content propModal contacto">
				  ...
				  <h3><span id="cuadAdorno">·</span>Contacto</h3>
					<form id="contactenos" action="#">
						...
						<div class="form-group">
							<a value="Enviar" class="btn btn-default" onclick="enviarCorreo(1)">Enviar</a>
						</div>
    ...
    <div class="modal-content propModal contacto" style="height: 530px">
				  ...
				  <h3><span id="cuadAdorno">·</span>Contacto</h3>
					<form id="trabaje">
						...
						<div class="form-group">
							<a value="Enviar" class="btn btn-default" onclick="enviarCorreo(2)">Enviar</a>
						</div>
						<div class="cerrarFormulario">cerrar[x]</div>
					</form>

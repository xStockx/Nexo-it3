<article id="pieTitulares">
			...
			<div class="cajaPieTit" id="cajaPieTit1">
					...
					<p><strong>Arquitecturas:</strong><br>
					múltiples capas, basadas en Web, Cliente/Servidor,<br>
					Arquitecturas orientadas a Servicios (SOA).</p>
 
					<p><strong>Herramientas:</strong> <br>
					JAVA, JEE, ASP .net, PHP, HTML 5, C++ <br>
					SAP Netweaver <br>
					Especialistas Genexus</p>
 
					<p><strong>Ambientes:</strong> <br>
					Oracle, MS SQL Server, MySQL, Sybase. <br>	
					IBM-DB2, AS/400</p>
			</div>
